...
Collected 17 deduplicated papers for profile `mof_ml_method_prior_art`. `ML` appears in 10 papers and `DFT` in 8. `Adsorption/separation` themes appear more often (4) than `catalysis` themes (4). `Interatomic-potential` or MLIP-style work appears in 7 papers and is a notable transfer path from COF-side methods to MOFs.
...
### 8. Sustainable Metal-Organic Framework Water Harvesters in the Artificial Intelligence Era
...
### 11. Supporting Dataset for Benchmarking Universal Machine-Learned Interatomic Potentials for High-Temperature Metal-Organic Framework Chemistry
...
### 13. ReadMOF: Structure-Free Semantic Embeddings from Systematic MOF Nomenclature for Machine Learning
...
### 14. Are Atoms Enough? An Explainable Graph Neural Network for Carbon Capture and Gas Separation in Metal-Organic Frameworks
...
### 16. Generation of magnetic metal-organic frameworks
...
### 17. BaLoRA: Bayesian Low-Rank Adaptation of Large Scale Models
