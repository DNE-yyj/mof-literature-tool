...
Collected 16 deduplicated papers for profile `mof_ml_method_prior_art`. `ML` appears in 9 papers and `DFT` in 7. `Adsorption/separation` themes appear more often (2) than `catalysis` themes (2). `Interatomic-potential` or MLIP-style work appears in 6 papers and is a notable transfer path from COF-side methods to MOFs.
...
### 2. MOFBuilder: automated end-to-end modeling of MOF dynamics for high-throughput screening

- Date: `2026-04-17`
- Journal: npj Computational Materials
- Link: https://doi.org/10.1038/s41524-026-02086-x
- Tags: adsorption, high_throughput, md, ml, mof, porous_material, priority_journal, separation
...
### 3. LEGO-MOF: Equivariant Latent Manipulation for Editable, Generative, and Optimizable MOF Design

- Date: `2026-04-15`
- Journal: ArXiv.org
- Link: https://arxiv.org/abs/2604.13520
- Tags: adsorption, co2, equivariant_ml, generative_model, h2, md, ml, mof, separation, surrogate_model
- Authors: Chaoran Zhang, Guangyao Li, Dongxu Ji
- Why it matters: Building upon this, we introduce a test-time optimization (TTO) strategy, utilizing an accurate surrogate model to continuously optimize the latent graphs of existing MOFs toward desired properties.
- Innovation: Building upon this, we introduce a test-time optimization (TTO) strategy, utilizing an accurate surrogate model to continuously optimize the latent graphs of existing MOFs toward desired properties.
...
### 16. Use of Machine Learning models as surrogate models for finding regions of structural properties of MOFs with high hydrogen storage capacities at room temperature and moderate pressures

- Date: `2026-04-20`
- Journal: Chemical Physics
- Link: https://doi.org/10.1016/j.chemphys.2026.113209
- Tags: h2, ml, mof, surrogate_model
- Authors: A. Granja-DelRío, F. Hernando-Gallego, I. Cabria
- Why it matters: Use of Machine Learning models as surrogate models for finding regions of structural properties of MOFs with high hydrogen storage capacities at room temperature and moderate pressures
- Innovation: Use of Machine Learning models as surrogate models for finding regions of structural properties of MOFs with high hydrogen storage capacities at room temperature and moderate pressures
- Likely limitations: Likely sensitive to training-set coverage and transferability across chemistries.
- Next step: Benchmark uncertainty and out-of-domain behavior before broad screening claims.
- MOF relevance: Already in the MOF literature; keep it only if the method adds a new representation, label space, or uncertainty/active-learning angle.
