...
Collected 16 deduplicated papers for profile `mof_ml_method_prior_art`. `ML` appears in 9 papers and `DFT` in 8. `Catalysis` themes appear more often (4) than `adsorption/separation` themes (3). `Interatomic-potential` or MLIP-style work appears in 7 papers and is a notable transfer path from COF-side methods to MOFs.
...
### 6. Sustainable Metal-Organic Framework Water Harvesters in the Artificial Intelligence Era
...
### 7. Supporting Dataset for Benchmarking Universal Machine-Learned Interatomic Potentials for High-Temperature Metal-Organic Framework Chemistry
...
### 8. Benchmarking Universal Machine-Learned Interatomic Potentials for High-Temperature Metal-Organic Framework Chemistry
...
### 9. Supporting Dataset for Benchmarking Universal Machine-Learned Interatomic Potentials for High-Temperature Metal-Organic Framework Chemistry
...
### 10. Benchmarking Universal Machine-Learned Interatomic Potentials for High-Temperature Metal-Organic Framework Chemistry
...
### 13. Are Atoms Enough? An Explainable Graph Neural Network for Carbon Capture and Gas Separation in Metal-Organic Frameworks

- Date: `2026-06-02`
- Journal: ChemRxiv
- Link: https://doi.org/10.26434/chemrxiv.15004189/v1
- Tags: adsorption, co2, crystal, gnn, h2, high_throughput, ml, mof, separation, uncertainty
- Authors: Abdulmujeeb T. Onawole
- Why it matters: We introduce PoreGCN, a heterogeneous graph neural network in which Voronoi-derived pore vertices sit alongside atoms via dedicated atom-to-pore edges, giving the model a direct view of the cavities that govern adsorption and separation.
- Innovation: We introduce PoreGCN, a heterogeneous graph neural network in which Voronoi-derived pore vertices sit alongside atoms via dedicated atom-to-pore edges, giving the model a direct view of the cavities that govern adsorption and separation.
...
### 14. Comparative entropy analysis of 2D transition metal tetrahydroxyquinones via machine learning approaches
...
### 15. Generation of magnetic metal-organic frameworks
...
### 16. BaLoRA: Bayesian Low-Rank Adaptation of Large Scale Models
